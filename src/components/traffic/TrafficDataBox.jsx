  ...
  return (
    <div className="w-full h-full flex flex-col justify-between">
      ...
      <div className="flex w-full h-full bg-[#FABCCD] rounded-[20px] p-8 flex flex-col gap-y-4">
        ...
        {data === undefined ? (
          ...
          <div className="w-full h-full flex flex-col gap-y-4">
            <div>
              <p>Number of Record: {data.number_of_records}</p>
            </div>
      ...
      <div className="flex w-full h-full justify-between py-8 gap-x-8">
        ...
        <div className="flex flex-col justify-between items-center w-full h-full gap-y-2">
          {/* Speed Box */}
          ...
          (<div className="flex flex-col items-center justify-center gap-y-2 w-full py-[3vh] bg-gray-200 rounded-[20px]">
            ...
            <div className="flex items-center gap-x-4">
              <p className="text-4xl font-bold">{data.average_speed.toFixed(2)}</p>
          ...
          <div className="relative flex items-center justify-center gap-x-8 w-full h-[130px] bg-[#F4CED9] opacity-70 rounded-[20px]">
        ...
        <div className="flex flex-col w-full h-full gap-y-4">
          ...
          (<div className="flex flex-col items-center justify-center gap-y-2 w-full py-[4vh] bg-gray-200 rounded-[20px]">
            ...
            <div className="flex items-center gap-x-4">
              ...
              <p className="text-4xl font-bold">{data.average_heartrate.toFixed(2)} BPM</p>
            </div>
          </div>)}
          ...
          (<div className="flex flex-col items-center justify-center gap-y-2 w-full py-[3vh] bg-gray-200 rounded-[20px]">
            ...
            <div className="flex items-center gap-x-4">
              <p className="text-4xl font-bold">{data.average_travel_time.toFixed(2)} min</p>
